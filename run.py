...
def train_final_model(
    ...
    if final_sched_name == "nagfree":
        ...
        schedule = None
    print(
        f"[Final Training] Using schedule: {final_sched_name}, Adam: {final_use_adam} with lambda={best_lambda}, gamma={best_gamma}"
    )
...
def main():
    ...
    print(
        f"Best hyperparameters found: lambda={best_lambda}, gamma={best_gamma}, threshold={best_threshold}, mean_f1={mean_f1}"
    )
